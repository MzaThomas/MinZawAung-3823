...
class ContractForm(forms.Form):
	...
	email = forms.EmailField(label='Enter Email', widget=widgets.EmailInput(attrs={'placeholder':'Your Email' , 'class': 'form-control'}))
	...
	duration = forms.DecimalField(label='Enter Duration(Month)', widget=widgets.NumberInput(attrs={'placeholder':'Duration' , 'class': 'form-control'}))
