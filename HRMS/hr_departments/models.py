...
class DepartmentModel(models.Model):
	...
	monthly_expenses = models.CharField(max_length=20, verbose_name='Monthly Expenses', default=None)
	note = models.TextField(max_length=100, verbose_name='Note')
	resources = models.CharField(max_length=20, verbose_name='Resources', default='normal')
